...
add_library(picow_bt_unicorn_audio INTERFACE)

target_sources(picow_bt_unicorn_audio INTERFACE
#    ${CMAKE_CURRENT_LIST_DIR}/galacticaudio.cpp
    ${PICO_BTSTACK_PATH}/src/btstack_audio.c
)

target_link_libraries(picow_bt_unicorn_audio INTERFACE
    pico_stdlib
    pico_btstack_ble
...
target_include_directories(picow_bt_unicorn_audio INTERFACE
    ${BTSTACK_CONFIG_PATH}/ # Use our own config
    ${BTSTACK_EXAMPLE_PATH}/
)

target_compile_definitions(picow_bt_unicorn_audio INTERFACE
    TEST_AUDIO=1
    CYW43_LWIP=0
